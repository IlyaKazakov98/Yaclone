...
import com.readyfo.yaclone.presentation.presenters.HistoryPresenter
import com.readyfo.yaclone.presentation.ui.adapters.HistoryAdapter
import com.readyfo.yaclone.presentation.views.HistoryView
...
class HistoryFragment : MvpAppCompatFragment(), HistoryView, HistoryAdapter.OnClickFavorites {
    ...
    fun provideHistoryPresenter(): HistoryPresenter{
        return HistoryPresenter(fetchHistoryUseCase = fetchHistoryUseCaseImpl)
    }
